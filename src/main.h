...
static const int64 MAX_MONEY = 42000000 * COIN; // maximum number of coins (42,000,000)
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 100 / 250; // 5760 blocks found a day. Priority cutoff is 1 SMC day / 250 bytes.
    }
